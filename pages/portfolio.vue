...
.ms--images {
  ...
  .ms-slide {
    &:nth-child(1) .ms-slide__image {
      background-image: url('https://cdn.rawgit.com/lmgonzalves/momentum-slider/3b3037f7/portfolio-carousel/img/harvey-gibson-498362-unsplash.jpg');
    }
    &:nth-child(2) .ms-slide__image {
      background-image: url('https://cdn.rawgit.com/lmgonzalves/momentum-slider/3b3037f7/portfolio-carousel/img/andre-hunter-461305-unsplash.jpg');
    }
    &:nth-child(3) .ms-slide__image {
      background-image: url('https://cdn.rawgit.com/lmgonzalves/momentum-slider/3b3037f7/portfolio-carousel/img/joanna-nix-389128-unsplash.jpg');
    }
    &:nth-child(4) .ms-slide__image {
      background-image: url('https://cdn.rawgit.com/lmgonzalves/momentum-slider/3b3037f7/portfolio-carousel/img/jurica-koletic-321003-unsplash.jpg');
    }
  }
